...
public class OpenTaintReaderTest extends ReaderTestBase {
    ...
    void readerHandlesGivenResultFile() throws Exception {
        ...
        assertEquals(CweNumber.WEAK_HASH_ALGO, result.getTestCaseResults("2670").get(0).getCWE());
        assertEquals(CweNumber.INSECURE_COOKIE, result.getTestCaseResults("2710").get(0).getCWE());
    }
